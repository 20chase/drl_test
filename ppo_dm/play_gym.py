...
parser.add_argument(
    '--train', default=False, type=bool, help='Whether to train')
...
class PlayGym(object):
    ...
    def learn(self):
        ...
        loss_names = ['policy_loss', 'value_loss', 'policy_entropy', 'approxkl', 'beta']
        nenvs = env.num_envs
        ...
        d_targ = self.args.d_targ
        kl = 0.01

        def adaptive_beta_lr(beta, lr_multiplier, kl, d_targ):
            if kl > d_targ * 2.:
                beta = np.minimum(35, 1.5*beta)
        ...
        for update in range(1, nupdates+1):
            ...
            beta, lr_multiplier = adaptive_beta_lr(beta, lr_multiplier, kl, d_targ)
            lrnow = lr_start * lr_multiplier
            ...
            for _ in range(noptepochs):
                ...
                for start in range(0, nbatch, nbatch_train):
                    ...
                    mblossvals.append(self.agent.train(lrnow, beta, *slices))
...
if __name__ == '__main__':
    ...
    ob_space = env.observation_space
    ac_space = env.action_space
    agent = DPPO(session, args, ob_space, ac_space)
